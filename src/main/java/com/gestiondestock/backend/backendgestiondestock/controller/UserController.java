...
public class UserController {
    ...
    /*@PostMapping("unblockedUser/{id}/{loginAgent}")
    public User unblockedDate(@PathVariable Long id, @PathVariable  String loginAgent) {
    	return userService.unblockedDate(id, loginAgent);
    }*/
